...
public class FormManutencoes extends JFrame implements ActionListener{
	...
	private JLabel id, data, maquina , custoHora, tempGasto; 
	...
	FormManutencoes(){
		...
		tfdata.setBounds(80,80,86,25);
		tfdata.setEditable(false);
		painel.add(data);
		painel.add(tfdata);
		
	    maquina = new JLabel("Maquinas:");
	    maquina.setBounds(50,140,100,14);
	    painel.add(maquina);
	    Equipamentos = new JComboBox<String>(new String[] { "Leg Press 45°","Mesa Extensora","Smith Maquina","Esteira","Agachamento Maquina","Aparelho Crossover"});
	    Equipamentos.setBounds(150,135,130, 25);
	    painel.add(Equipamentos);
	    
	    custoHora = new JLabel("Custo de hora:");
	    custoHora.setBounds(50,190, 100, 14);
	    tfcustoHora = new JTextField();
		tfcustoHora.setBounds(150,185,86,25);
		...
		tftempGasto.setBounds(150,235,86,25);
		...
		cadastrar.setBounds(420, 195, 110, 30);
		buscar.setBounds(420, 250, 110, 30);
